...
showMenu = (msg) => {
  msg.reply([
    ...
    '*GAME CENTER* 🎮',
    '`/game` - Daftar 12 mini-game',
    '`/tetris` `/xo` `/pacman` `/snake` `/2048`',
    '`/hangman` `/tebakkata` `/sambungkata`',
    '`/quiz` `/matematika` `/ranjau` `/mafia`',
    '`/skor` - Papan skor · `/stopgame` - Hentikan game', '',
    '*GRUP*',
...
const showInfo = (msg) => {
  ...
  msg.reply([
    ...
    '🎮 Game Center: 12 mini-game + papan skor',
